...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-api-vision-video.sh` on the terminal.
...
## Explore Process for Scanning Content Using Video Intelligence and Vision APIs

This asset enables you to explore the process for scanning content using Video Intelligence and Vision APIs
...
This asset enables you to perform the following activities:
 ...
 - Create Cloud Storage notifications
